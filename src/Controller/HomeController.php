...
class HomeController extends AbstractController
{
    ...
    {
        $defaults = [
            'hero_badge'           => 'Fait main · Atelier artisanal',
            'hero_title'           => 'Conçu pour vous,',
            'hero_title_highlight' => 'gravé à la main.',
            ...
            'sf_subtitle'          => 'Chaque projet est pensé et réalisé à la main dans notre atelier, selon vos envies et vos matériaux — pas selon un catalogue.',
            'sf_1_icon'            => '🎁',
            ...
            'sf_2_desc'            => 'Chêne, hêtre, noyer. La chaleur du bois naturel sublimée par une gravure artisanale, précise et durable.',
            'sf_3_icon'            => '🥃',
            'sf_3_title'           => 'Gravure sur verre',
            'sf_3_desc'            => 'Verres, carafes, bouteilles : une finition raffinée, réalisée à la main pour vos événements les plus précieux.',
            'sf_4_icon'            => '💼',
